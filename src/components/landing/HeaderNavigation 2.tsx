          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden md:flex items-center space-x-4 flex-1 max-w-3xl mx-8">
              ...
              <Link
                ...
                onClick={(e) => {
                  console.log('Clique no botão Kits Prontos - Desktop')
                }}
              >
                Kits Prontos
              </Link>
          ...
          >
            <div className="container mx-auto px-4 py-6">
              <div className="flex flex-col space-y-4">
                ...
                <Link
                  href="/kits"
                  className="text-purple-600 font-medium py-2 px-4 rounded-lg hover:bg-purple-50 transition-colors duration-300"
                  onClick={(e) => {
                    console.log('Clique no botão Kits Prontos - Mobile')
                    setIsMobileMenuOpen(false)
                  }}
                >
                  Kits Prontos
