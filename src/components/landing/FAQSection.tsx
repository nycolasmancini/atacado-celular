...
export default function FAQSection() {
  ...
  const handleVerProdutosClick = () => {
    // Scroll to the top or redirect to catalog
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  ...
                  className="bg-success hover:bg-green-600 text-white font-montserrat font-semibold text-16px px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center"
                >
                ...
                <button 
                  onClick={handleVerProdutosClick}
                  className="bg-primary-orange hover:bg-orange-600 text-white font-montserrat font-semibold text-16px px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  Ver Produtos
                </button>
              </div>
