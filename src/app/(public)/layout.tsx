    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'PMCELL - Atacado de Acessórios para Celular',
      },
    ],
  },
  twitter: {
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    CNPJ: 29.734.462/0003-86<br />
                    Rua Comendador Abdo Schahin, 62, Loja 4<br />
                    CEP 01023-050, Centro, São Paulo
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">(11) 98132-6609</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">(11) 91130-4693</p>
                        <p className="text-sm text-gray-400">Segunda a Sexta, 8h às 18h</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <span>nycolas@pmcellsaopaulo.com.br</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t border-gray-800 mt-8 pt-8 text-center">
                <p className="text-gray-400 text-sm">
                  © 2025 PMCELL. Todos os direitos reservados.
                </p>
              </div>
            </div>
          </footer>
